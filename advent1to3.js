...
// var a = [1,0,0,3,1,1,2,3,1,3,4,3,1,5,0,3,2,1,9,19,1,5,19,23,1,6,23,27,1,27,10,31,1,31,5,35,2,10,35,39,1,9,39,43,1,43,5,47,1,47,6,51,2,51,6,55,1,13,55,59,2,6,59,63,1,63,5,67,2,10,67,71,1,9,71,75,1,75,13,79,1,10,79,83,2,83,13,87,1,87,6,91,1,5,91,95,2,95,9,99,1,5,99,103,1,103,6,107,2,107,13,111,1,111,10,115,2,10,115,119,1,9,119,123,1,123,9,127,1,13,127,131,2,10,131,135,1,135,5,139,1,2,139,143,1,143,5,0,99,2,0,14,0]
// a is the array
// replace position 1 with the value 12 and replace position 2 with the value 2.
// var a1 = [1,0,0,3,1,1,2,3,1,3,4,3,1,5,0,3,2,1,9,19,1,5,19,23,1,6,23,27,1,27,10,31,1,31,5,35,2,10,35,39,1,9,39,43,1,43,5,47,1,47,6,51,2,51,6,55,1,13,55,59,2,6,59,63,1,63,5,67,2,10,67,71,1,9,71,75,1,75,13,79,1,10,79,83,2,83,13,87,1,87,6,91,1,5,91,95,2,95,9,99,1,5,99,103,1,103,6,107,2,107,13,111,1,111,10,115,2,10,115,119,1,9,119,123,1,123,9,127,1,13,127,131,2,10,131,135,1,135,5,139,1,2,139,143,1,143,5,0,99,2,0,14,0]
// var a = [1,9,10,3,2,3,11,0,99,30,40,50]
// a[1] = 12
// a[2] = 2
// console.log(a)
// var a1 = []
...
// var data = [path1, path2]
// var points = new Array();
// data.forEach(function(paths,j){
// 	var x = 0;
// 	var y = 0;
// 	var steps = 0;
// 	points[j] = {};
...
// 			}
// 			steps += 1
// 			points[j][[x,y].toString()] = steps
// 		}
// 	})
// })

// var p1 = new Set(Object.keys(points[0]))
// var p2 = new Set(Object.keys(points[1]))

// var intersection = new Set(
//     [...p1].filter(x => p2.has(x)));
// var reducer = (accumulator, currentValue) => Math.abs(parseInt(accumulator)) + Math.abs(parseInt(currentValue));
// var final_array = []
// intersection.forEach(function(value){
// 	final_array.push(value.split(/,/).reduce(reducer))
// })
// console.log(intersection.size)


// var short_time = Number.POSITIVE_INFINITY
// var short_arr = []
//  intersection.forEach(function(inter){
//     var distance = 0
//     points.forEach(function(paths){
//         distance+=paths[inter]
//     })
//     short_arr.push(distance)
//     if(distance<short_time){
//     	short_time = distance
//     }
//  })
