...
function computer(input){
    ...
    while (computing) {
        ...
        if (parseInt(new_op) == 1) {
            ...
            // input.splice(0, 1)[0];
            // console.log('giving input', String.fromCharCode(tem_input), tem_input)
            // console.log(String.fromCharCode(tem_input))
...
// main_r.push('\n'.charCodeAt());
// var arr = [];
// var path = ['R4','R10','L12'], // This is A
// var path =['L8','R10','R10','R6'] // This is B
// var path = ['R4','L12','L8','R4'] // This is C
...
// arr.pop()
// arr.push(10)
var subroutine = [65, 44, 66, 44, 65, 44, 67, 44, 65, 44, 66, 44, 65, 44, 67, 44, 66, 44, 67, 10, 82, 44, 52, 44, 76, 44, 49, 50, 44, 76, 44, 56, 44, 82, 44, 52, 10, 76, 44, 56, 44, 82, 44, 49, 48, 44, 82, 44, 49, 48, 44, 82, 44, 54, 10, 82, 44, 52, 44, 82, 44, 49, 48, 44, 76, 44, 49, 50, 10, 110, 10];
